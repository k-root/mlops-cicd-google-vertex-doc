...
FROM tmp_table
""".format("springml-notebook-testing","mlops_tutorial","chicago_taxitrips_prep")
# Get default credentials
credentials, project = auth.default()
bqclient = bigquery.Client(credentials=credentials, project="springml-notebook-testing")
...
# df.to_csv(data.path + ".csv" , index=False, encoding='utf-8-sig')
...
## Train a regression model to predict the fares
